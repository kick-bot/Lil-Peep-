...
Modelo ${prefix}daftar para começar a usar bot.`
  ...
  only: {
    ...
    daftarB: `𝐒𝐄 𝐂𝐀𝐃𝐀𝐒𝐓𝐑𝐀 𝐀𝐈, 𝐅𝐃𝐏 *${prefix}𝐃𝐀𝐅𝐓𝐀𝐑* 𝐏𝐑𝐀 𝐓𝐔 𝐂𝐎𝐌𝐄𝐜̧𝐀 𝐔𝐒𝐀 𝐎 𝐁𝐎𝐓😐`
...
//clear all chat
				...
				case 'linpa chat do bot':
					...
					if (!isOwner) return reply('se pode ussa esse comando n caraio sono kick-ass')
